...
- **timeframe** - какой таймфрейм из доступный: 1Min, 15Min, 1Hour, 1Day. По дефолту - 1Hour
...
```javascript
{
    ...
    "data": {
        ".AAPL": [
            {
                "t": "2022-01-10T13:00:00Z",	//время
                "o": 170.05,	//Open price
                "h": 170.25,	//High price
                "l": 169,	//Low price
                "c": 169.23,	//Close price
                "vwap": 169.666642 //VWAP price per timeframe
            }
        ],
        ".V": [
            ...
